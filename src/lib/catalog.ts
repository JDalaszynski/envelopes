...
export interface EnvelopeColor {
  ...
  /** Zdjęcia podglądowe dla opcji nadruku (przód koperty) */
  printImages?: Partial<Record<FormatId, string>>;
  /**
   * Zdjęcia podglądowe nadruku na zamknięciu — ten sam kadr co koperta
   * gładka (klapka przedniej koperty jest na pierwszym planie), z polem
   * nadruku zaznaczonym na klapce tą samą ikoną, co w `printImages`.
   */
  flapPrintImages?: Partial<Record<FormatId, string>>;
...
export const COLORS: EnvelopeColor[] = [
  // Szarości / Czarny
  { id: 'czarny', name: 'Czarny', hex: '#23242A', dark: true, bestseller: true, weight: '115g', images: { DL: '/images/colors/czarne-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/czarne-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/czarne-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/czarne-koperty-personalizowane-dl-1200.webp' } },
  { id: 'szara', name: 'Szara', hex: '#9A9A96', weight: '115g', images: { DL: '/images/colors/szare-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/szare-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/szare-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/szare-koperty-personalizowane-dl-1200.webp' } },

  // Niebieskie
  { id: 'granatowy', name: 'Granatowy', hex: '#22314F', dark: true, bestseller: true, weight: '115g', images: { DL: '/images/colors/granatowe-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/granatowe-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/granatowe-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/granatowe-koperty-personalizowane-dl-1200.webp' } },
  { id: 'niebieski', name: 'Niebieski', hex: '#3A5C8C', dark: true, weight: '115g', images: { DL: '/images/colors/niebieskie-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/niebieskie-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/niebieskie-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/niebieskie-koperty-personalizowane-dl-1200.webp' } },
  { id: 'blekit-lupkowy', name: 'Jeansowy', hex: '#6E8395', bestseller: true, weight: '120g', images: { DL: '/images/colors/jeansowe-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/jeansowe-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/jeansowe-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/jeansowe-koperty-personalizowane-dl-1200.webp' } },
  { id: 'jasnoniebieska', name: 'Błękitna', hex: '#B9CBDD', weight: '115g', images: { DL: '/images/colors/blekitne-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/blekitne-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/blekitne-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/blekitne-koperty-personalizowane-dl-1200.webp' } },

  // Zielenie
  { id: 'ciemnozielony', name: 'Butelkowa Zieleń', hex: '#2F4A38', dark: true, weight: '115g', images: { DL: '/images/colors/ciemnozielone-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/ciemnozielone-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/ciemnozielone-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/ciemnozielone-koperty-personalizowane-dl-1200.webp' } },
  { id: 'matcha', name: 'Matcha', hex: '#A8B78C', bestseller: true, weight: '120g', images: { DL: '/images/colors/matcha-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/matcha-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/matcha-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/matcha-koperty-personalizowane-dl-1200.webp' } },
  { id: 'jasnozielony', name: 'Zielony', hex: '#BFD3A8', weight: '115g', images: { DL: '/images/colors/zielone-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/zielone-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/zielone-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/zielone-koperty-personalizowane-dl-1200.webp' } },

  // Róże / Czerwienie
  { id: 'czerwony', name: 'Czerwony', hex: '#8E2B2B', dark: true, weight: '115g', images: { DL: '/images/colors/czerwone-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/czerwone-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/czerwone-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/czerwone-koperty-personalizowane-dl-1200.webp' } },
  { id: 'rozowa', name: 'Różowa', hex: '#E6C3C1', weight: '115g', images: { DL: '/images/colors/rozowe-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/rozowe-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/rozowe-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/rozowe-koperty-personalizowane-dl-1200.webp' } },

  // Żółte / Ziemiste
  { id: 'taupe', name: 'Szarobrązowy', hex: '#9C8C7E', weight: '140g', images: { DL: '/images/colors/szarobrazowe-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/szarobrazowe-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/szarobrazowe-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/szarobrazowe-koperty-personalizowane-dl-1200.webp' } },
  { id: 'eko', name: 'Eko', hex: '#C6AE8B', finish: 'eko', weight: '115g', images: { DL: '/images/colors/eko-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/eko-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/eko-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/eko-koperty-personalizowane-dl-1200.webp' } },
  ...
  // Jasne / Kremowe
  { id: 'ecru', name: 'Ecru', hex: '#EADFC8', weight: '115g', images: { DL: '/images/colors/ecru-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/ecru-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/ecru-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/ecru-koperty-personalizowane-dl-1200.webp' } },
  { id: 'bialy', name: 'Biały', hex: '#FBFAF7', bestseller: true, weight: '115g', images: { DL: '/images/colors/biale-koperty-ozdobne-dl-1200.webp' }, printImages: { DL: '/images/prints/biale-koperty-z-nadrukiem-dl-1200.webp' }, flapPrintImages: { DL: '/images/prints-flap/biale-koperty-z-nadrukiem-na-zamknieciu-dl-1200.webp' }, personalizedImages: { DL: '/images/personalized/biale-koperty-personalizowane-dl-1200.webp' } },
];
